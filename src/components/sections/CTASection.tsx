        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
            {[...Array(5)].map((_, i) => (
              <div
                key={`center-${i}`}
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-white/10 animate-radar-pulse"
                style={{
          ...
          <div className="absolute bottom-[25%] right-[15%]">
            {[...Array(4)].map((_, i) => (
              <div
                key={`right-${i}`}
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full border border-brand-coral/20 animate-radar-pulse-slow"
                style={{
          ...
          {[...Array(4)].map((_, i) => (
            <div
              key={`wave-${i}`}
              className="absolute left-0 right-0 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent animate-wave-horizontal"
              style={{
                top: `${15 + i * 25}%`,
          ...
          <svg className="absolute inset-0 w-full h-full opacity-10">
            ...
            <line x1="85%" y1="75%" x2="50%" y2="50%" stroke="currentColor" strokeWidth="0.5" className="text-brand-coral animate-pulse" style={{ animationDelay: '1s' }} />
            <line x1="10%" y1="30%" x2="85%" y2="75%" stroke="currentColor" strokeWidth="0.3" className="text-white animate-pulse" style={{ animationDelay: '2s' }} />
          </svg>
        </div>
